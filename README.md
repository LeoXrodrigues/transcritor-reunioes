...
![Aplicação funcionando](evidencias/09-app-navegador.png)
...
![CLAUDE.md no editor](evidencias/00-claude-md.png)

Modelo utilizado na sessão: **Sonnet 5**, via Claude Code v2.1.237.

![Modelo utilizado](evidencias/01-modelo.jpeg)
...
![Prompt principal](evidencias/02-prompt-principal.jpeg)

![Linha de pensamento da IA](evidencias/03-linha-de-pensamento.jpeg)

![Primeiro retorno](evidencias/04-primeiro-retorno.jpeg)
...
![Teste A](evidencias/05-teste-a-rodape.jpeg)

![Teste B](evidencias/06-teste-b-rodape.jpeg)
...
![Teste 1 — arquivo inteiro](evidencias/07-teste1-arquivo-inteiro.jpeg)

![Teste 2 — só o trecho](evidencias/08-teste2-so-trecho.jpeg)
...
![Custo do ajuste de formatação](evidencias/muda-formatacao-texto-de-anthropic.png)

![Custo da adaptação para a Vercel](evidencias/custo-adapta-vercel.png)

![Refatoração para chamar API](evidencias/refatora-projeto-para-chamar-api-e-express.png)
...
![Tabela de preços oficial](evidencias/10-pricing.png)
